...
' 
' This example demonstrates how to emulate FormView behavior using the
' ASPxGridView.
' That is, on the ASPxGridView page, only one record is always
' displayed in edit mode.
' 
' You can find sample updates and versions for different programming languages here:
' http://www.devexpress.com/example=E2010
