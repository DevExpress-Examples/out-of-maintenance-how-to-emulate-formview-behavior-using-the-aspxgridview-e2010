...
<%@ Register Assembly="DevExpress.Web.v9.3" Namespace="DevExpress.Web.ASPxMenu" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.ASPxGridView.v9.3" Namespace="DevExpress.Web.ASPxGridView" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v9.3" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>
...
<body>
    ...
    <div>
        <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" DataSourceID="ProductsDataSource" KeyFieldName="ProductID" Width="450px"
            OnDataBound="grid_DataBound" OnCellEditorInitialize="grid_CellEditorInitialize" OnInitNewRow="grid_InitNewRow">
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="CategoryID" VisibleIndex="1" Caption="Category">
                    <PropertiesComboBox DataSourceID="CategoriesDataSource" ValueType="System.Int32" TextField="CategoryName" ValueField="CategoryID" />
                ...
                <dx:GridViewDataTextColumn FieldName="ProductID" ReadOnly="True" VisibleIndex="7" Visible="False" />
            </Columns>
            <Templates>
                <EditForm>
                    <dx:ASPxMenu ID="editFormMenu" runat="server" ClientInstanceName="editFormMenu" Width="100%" AutoPostBack="false"
                        EnableHotTrack="true" EnableClientSideAPI="True" ItemAutoWidth="False">
                        <Items>
        ...
        <asp:AccessDataSource ID="ProductsDataSource" runat="server" DataFile="~/App_Data/nwind.mdb"
            ...
            InsertCommand="INSERT INTO [Products] ([ProductName], [CategoryID], [QuantityPerUnit], [UnitPrice],
                                       [UnitsInStock], [UnitsOnOrder], [Discontinued]) VALUES (?, ?, ?, ?, ?, ?, ?)"
            OnDeleting="ProductsDataSource_Modifying" OnInserting="ProductsDataSource_Modifying" OnUpdating="ProductsDataSource_Modifying">
            <UpdateParameters>
